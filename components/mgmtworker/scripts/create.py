...
def _install_optional(mgmtworker_venv):
    ...
    if rest_client_source_url:
        utils.install_python_package(rest_client_source_url, mgmtworker_venv, constraints_file)
    if plugins_common_source_url:
        utils.install_python_package(
            plugins_common_source_url, mgmtworker_venv, constraints_file)
    if script_plugin_source_url:
        utils.install_python_package(script_plugin_source_url, mgmtworker_venv, constraints_file)
    if agent_source_url:
        utils.install_python_package(agent_source_url, mgmtworker_venv, constraints_file)
    ...
    if rest_service_source_url:
        ...
        utils.install_python_package(riemann_dir, mgmtworker_venv, constraints_file)
        utils.install_python_package(workflows_dir, mgmtworker_venv, constraints_file)
